mod builder {
    ...
    mod unhappy {
        ...
        mod missing_mandatory_fields {
            ...
            #[fixture]
            fn test_cases_data() -> Vec<(&'static str, fn() -> Result<StringClapArg, String>, &'static str)> {
                vec![
            ...
            #[rstest]
            fn test_that_correct_error_returned_when_missing_mandatory_fields(
                test_cases_data: Vec<(&str, fn() -> Result<StringClapArg, String>, &str)>,
            ) {
